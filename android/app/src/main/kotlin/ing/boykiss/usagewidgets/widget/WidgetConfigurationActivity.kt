package ing.boykiss.usagewidgets.widget
...
import ing.boykiss.usagewidgets.UsageWidgetsApplication
import ing.boykiss.usagewidgets.data.database.AccountEntity
import ing.boykiss.usagewidgets.data.database.WidgetConfigurationEntity
import ing.boykiss.usagewidgets.domain.WidgetVisualStyle
import ing.boykiss.usagewidgets.sync.UsageSyncWorker
import ing.boykiss.usagewidgets.ui.theme.UsageWidgetsTheme
import ing.boykiss.usagewidgets.ui.theme.NothingFont
            ...
            UsageWidgetsTheme {
                Surface(
                    ...
                    Column(
                        ...
                        if (accounts.isEmpty()) Text("Connect an account in Usage Widgets first.")
